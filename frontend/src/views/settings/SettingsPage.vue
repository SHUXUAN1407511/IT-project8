    ...
    <el-row :gutter="16">
      <el-col :span="24" :lg="12">
        <el-card shadow="never" class="panel">
          ...
          <el-divider />
          <el-form :model="profileForm" :rules="profileRules" ref="profileFormRef" label-width="100px" hide-required-asterisk>
            <el-form-item label="Name" prop="name">
              <el-input v-model="profileForm.name" />
            </el-form-item>
            <el-form-item>
              <el-button class="outlined-button" :disabled="!canEditProfile" @click="saveProfile">
                Save changes
              </el-button>
            </el-form-item>
          </el-form>
      ...
      <el-col :span="24" :lg="12">
        <el-card shadow="never" class="panel">
          ...
          <el-form :model="passwordForm" :rules="passwordRules" ref="passwordFormRef" label-width="120px" hide-required-asterisk>
            ...
            <el-form-item>
              <el-button class="outlined-button" :disabled="!canEditProfile" @click="changePassword">
                Update password
              </el-button>
            </el-form-item>
          </el-form>
...
const canEditProfile = computed(() => !!userInfo.value);
