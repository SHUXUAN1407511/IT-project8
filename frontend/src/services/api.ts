...
export const AuthAPI = {
  ...
  login(payload: LoginRequest) {
    return http.post<LoginResponse>('/auth/login', { data: payload });
  },
  /**
  ...
  register(payload: RegisterRequest) {
    return http.post<RegisterResponse>('/auth/register', { data: payload });
  },
};
...
export const TemplatesAPI = {
  ...
  save(assignmentId: string, payload: SaveTemplateRequest) {
    return http.post<TemplateRecord>(`/assignments/${assignmentId}/template`, { data: payload });
  },
  /**
...
export const ScalesAPI = {
  ...
  saveVersion(payload: SaveScaleVersionRequest) {
    return http.post<ScaleRecord>('/scales/version', { data: payload });
  },
  /**
